#pragma checksum "C:\Projects\NotificationSystem\NotificationSystem.API\Views\NotificationTemplate\PostNotification.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "f406fee7d9d605a33bb7be635714e451576fb552"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"f406fee7d9d605a33bb7be635714e451576fb552", @"/Views/NotificationTemplate/PostNotification.cshtml")]
...
<div class=""col-12 col-xl-12"">
    <h2 class=""card-title""><span style=""font-size: 20px;""><strong>Add Notification Template</strong></span></h2>
    <div class=""card"">
        <div class=""card-header"">
        </div>
        <div class=""card-body"">
            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "f406fee7d9d605a33bb7be635714e451576fb5523933", async() => {
                WriteLiteral(@"
                <div class=""mb-3 row"">
                ...
                <div class=""mb-3 row"">
                    ...
                    <div class=""col-sm-10"">
                        <input type=""text"" class=""form-control"" placeholder=""Notification Type"">
                    </div>
                </div>
                <div class=""mb-3 row"">");
                WriteLiteral(@"
                    ...
                    <div class=""col-sm-10"">
                        <input type=""text"" class=""form-control"" placeholder=""Notification Channel"">
                    </div>
                </div>
                <div class=""mb-3 row"">
                    <label class=""col-form-label col-sm-2 text-sm-right"">Date Created</label>
                    <div class=""col-sm-10"">
                        <input type=""date"" class=""form-control"" placeholder=""Date Created"">
                    </div>
                </div>
                <div class=""mb-3 row"">
                    <label class=""col-form-label col-sm-2 text-sm-right"">Created By</label>
                    <div class=""col-sm-10"">
                        <input type=""text"" class=""form-control"" placeholder=""Full Name"">
                    </div>
                </div>
